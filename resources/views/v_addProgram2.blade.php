...
@section('content')
    <!-- Horizontal Form -->
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" id="quickForm" action="/program/insertDataProgram/<?= $id_rka ?>" method="POST"  enctype="multipart/form-data">
              @csrf
                <div class="card-body">
                
                    <div class="col-sm-10">
                      <input type="hidden" class="form-control" name="id_program" id="id_program" value="<?= $id_rka ?>">
                    </div>
